...
public class AutomatoFinitoNDeterministico {
    ...
    public AutomatoFinitoNDeterministico(Set<Estado> estados, Set<Character> alfabeto, Estado estadoInicial, Set<Estado> estadosFinais) {
    ...
    public void definirTransicoes(Estado estadoOrigem, Character simbolo, Set<Estado> estadosDestinos) {
        this.funcaoDeTransicao.get(estadoOrigem).put(simbolo, estadosDestinos);
    }
    ...
    public void verificarCadeia(String cadeia) {
        ...
        for (char simbolo : cadeia.toCharArray()) {
            ...
            estadoAtual = (Estado) funcaoDeTransicao.get(estadoAtual).get(simbolo);
        }
